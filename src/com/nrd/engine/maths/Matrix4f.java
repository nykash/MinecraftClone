...
public class Matrix4f {
    ...
    public static Matrix4f transform(Vector3f position, Vector3f rotation, Vector3f scalar) {
        ...
        Matrix4f rotXMatrix = Matrix4f.rotate(rotation.getX(), new Vector3f(1f, 0f, 0f));
        Matrix4f rotYMatrix = Matrix4f.rotate(rotation.getY(), new Vector3f(0f, 1f, 0f));
        Matrix4f rotZMatrix = Matrix4f.rotate(rotation.getZ(), new Vector3f(0f, 0f, 1f));
        Matrix4f scaleMatrix = Matrix4f.scale(scalar);
